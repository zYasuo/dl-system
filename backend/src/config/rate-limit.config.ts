...
import { buildAuthRateLimitConfig, type AuthRateLimitKey } from '../modules/auth/config/rate-limit.config';
import {
...
import { buildClientsRateLimitConfig, type ClientsRateLimitKey } from '../modules/clients/config/rate-limit.config';
import { buildTicketsRateLimitConfig, type TicketsRateLimitKey } from '../modules/tickets/config/rate-limit.config';
import { buildUsersRateLimitConfig, type UsersRateLimitKey } from '../modules/users/config/rate-limit.config';
